...
<head>
  ...
  <title>taller electronico</title>
  <link rel="stylesheet" type="text/css" href="admilte/dis/css/estilos.css">
  <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url(); ?>adminlte/dis/img/logot.jpg">
